    ...
    <section id="about" ref={ref} className="relative py-28 md:py-40 bg-milk">
      <div className="container-x grid lg:grid-cols-12 gap-12 lg:gap-20">
        <div className="lg:col-span-5 lg:sticky lg:top-32 lg:self-start">
          ...
          <Reveal delay={0.2}>
            <div className="mt-8 space-y-6 text-ink/75 max-w-md">
              <p className="leading-relaxed">
                Asel — современная швейная фабрика полного цикла, специализирующаяся на
                оптовом пошиве качественной одежды крупными партиями в Бишкеке. Мы осуществляем 
                производство трикотажа, детской одежды и школьной формы, обеспечивая быструю 
                доставку по всему СНГ (Россия, Казахстан, Беларусь). Сопровождаем заказчика 
                на всех этапах: от разработки лекал до маркировки и отправки готовой продукции 
                на маркетплейсы Wildberries и Ozon.
              </p>

              <div className="pt-6 border-t border-border/60">
                <h2 className="text-xl font-serif text-ink font-semibold">Оптовый пошив одежды в Кыргызстане</h2>
                <p className="mt-2 text-sm text-ink/70 leading-relaxed">
                  Швейная фабрика Asel производит одежду оптом для брендов, магазинов и предпринимателей. Мы работаем от разработки образца до упаковки готовой партии.
                </p>
              </div>

              <div className="pt-6 border-t border-border/60">
                <h2 className="text-xl font-serif text-ink font-semibold">Пошив детской и подростковой одежды</h2>
                <p className="mt-2 text-sm text-ink/70 leading-relaxed">
                  Мы осуществляем профессиональный пошив качественной детской, подростковой и школьной одежды. Разрабатываем лекала любой сложности и отшиваем изделия под ключ по выгодным оптовым ценам.
                </p>
              </div>
            </div>
          </Reveal>
